...
Each Django app can have a `components.py` module at the app root. Shrd's autodiscover imports it at startup and registers every `Component` subclass defined there.
